...
if __name__ == '__main__':
    #ts = time.time()
    date = datetime.datetime.today().strftime('%d-%m-%Y')  #date = datetime.datetime.fromtimestamp(ts).strftime('%d-%m-%Y')
    ...
    datef = tk.Label(frame4, text=day+"-"+month+"-"+year+"  |  ", fg="orange", bg="#262523", width=55, height=1, font=('times', 22, ' bold '))
